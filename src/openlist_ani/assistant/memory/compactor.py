...
class AutoCompactor:
    ...
    def _build_summary_messages(
        ...
        Anthropic (and some OpenAI-compatible APIs) require strictly
        alternating user/assistant roles.  Since system, tool, and
        user messages are all converted to ``Role.USER``, consecutive
        user messages must be merged into one.
        """
