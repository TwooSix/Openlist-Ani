...
class TestStateTransitions:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (DownloadState.DOWNLOADED, DownloadState.POST_PROCESSING),
            (DownloadState.DOWNLOADED, DownloadState.FAILED),
            (DownloadState.POST_PROCESSING, DownloadState.COMPLETED),
            (DownloadState.POST_PROCESSING, DownloadState.FAILED),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (DownloadState.PENDING, DownloadState.POST_PROCESSING),
